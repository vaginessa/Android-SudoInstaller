...
// import com.darkrealmgaming.androidapi.AssetManager; // I lost this, so SudoInstLib-AssetMgr will handle it's functions instead.
import com.darkrealmgaming.androidsudo.AssetManager; // SudoInstLib-AssetMgr
...
public class MainActivity extends FragmentActivity {
    	...
    	new Thread() {
    		public void run() {
    			...
    			if(Shell.SU.available()) {
    				...
    				Log.i(LOGTAG, "Using SudoInstLib-AssetMgr to extract files...");
        		...
        		new Thread() {
        			public void run() {
        				...
        				if(Shell.SU.available()) {
        	        		...
        	        		Log.i(LOGTAG, "Using SudoInstLib-AssetMgr to load OpenRecoveryScript...");
    ...
    // Version 3.x availability message class
    public void version222finalmessage(){
        MainActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Log.i(LOGTAG, "Prompting upgrade to 3.x");
                Builder suFailed = new AlertDialog.Builder(MainActivity.this);
                suFailed.setMessage(R.string.darkrealmgaming_goodbye_message);
                suFailed.setTitle(R.string.darkrealmgaming_goodbye_title);
                suFailed.setPositiveButton(R.string.darkrealmgaming_goodbye_playstore_button, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                ...
                suFailed.setNegativeButton(R.string.darkrealmgaming_goodbye_apk_button, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
